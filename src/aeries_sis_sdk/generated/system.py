...
class SystemNamespace:
    ...
    def get_aeries_installation_information(self, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        return self._client._call_operation("system.get_aeries_installation_information", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)
