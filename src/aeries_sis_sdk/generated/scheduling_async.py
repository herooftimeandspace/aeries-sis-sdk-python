...
class SchedulingAsyncNamespace:
    ...
    async def create_section_from_scheduling_master_schedule(self, school_code: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None, json: Any = None) -> Any:
        ...
        return await self._client._call_operation("scheduling.create_section_from_scheduling_master_schedule", path_params=path_params, params=params, json=json, headers=headers, database_year=database_year, timeout=timeout)

    async def get_course_data_changes(self, year: str | int, month: str | int, day: str | int, hour: str | int, minute: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_course_data_changes", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_course_information(self, course_id: str | int | None = None, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_course_information", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_section_class_roster(self, school_code: str | int, section_number: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_section_class_roster", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_section_class_roster_data_changes(self, year: str | int, month: str | int, day: str | int, hour: str | int, minute: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_section_class_roster_data_changes", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_section_data_changes_from_master_schedule(self, year: str | int, month: str | int, day: str | int, hour: str | int, minute: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_section_data_changes_from_master_schedule", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_section_from_scheduling_master_schedule(self, school_code: str | int, section_number: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        """Call the Aeries `Section (from Scheduling Master Schedule) ↑` endpoint.
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_section_from_scheduling_master_schedule", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_sections_from_master_schedule(self, school_code: str | int, section_number: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_sections_from_master_schedule", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    async def get_staff_classes_sections(self, staff_id: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return await self._client._call_operation("scheduling.get_staff_classes_sections", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)
