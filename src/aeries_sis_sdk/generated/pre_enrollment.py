...
class PreEnrollmentNamespace:
    ...
    def pre_enroll_inactive_student(self, student_id: str | int, next_school_code: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None) -> Any:
        ...
        return self._client._call_operation("pre_enrollment.pre_enroll_inactive_student", path_params=path_params, params=params, headers=headers, database_year=database_year, timeout=timeout)

    def pre_enroll_student(self, student_id: str | int, *, headers: Mapping[str, str] | None = None, database_year: str | int | None = None, timeout: float | None = None, extra_params: dict[str, Any] | None = None, json: Any = None) -> Any:
        ...
        if extra_params:
            params.update(extra_params)
        return self._client._call_operation("pre_enrollment.pre_enroll_student", path_params=path_params, params=params, json=json, headers=headers, database_year=database_year, timeout=timeout)
